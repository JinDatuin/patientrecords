          ...
          <div class="col-lg-6">
            <div class="p-5">
              <div class="text-center">
                <img width="70" height="70" src="<?php echo base_url(); ?>img/logo.png"><br><br>
                 <h6><b>Binalatongan Community College</b></h6>
                 <h1 class="h4 text-gray-900 mb-4">E-Clinic Record Management System </h1>
              </div>
              ...
              <div class="text-center">
                ...
                <a href="<?php echo base_url('admissioncontrol/public_search'); ?>" class="btn btn-link">
