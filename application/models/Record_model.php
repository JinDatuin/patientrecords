...
public function get_findings_by_patient($patient_id) {
    $this->db->where('pr_findings_id', $patient_id); // Adjust 'findings_id' if your FK column has a different name
    $query = $this->db->get('findings'); // Replace with your actual findings table name
    return $query->result();
}

public function get_admissions_by_patient($patient_id) {
    $this->db->where('pr_admission_id', $patient_id); // Adjust to match your admission table's foreign key
    $query = $this->db->get('admission_record'); // Replace with your actual admission table name
    return $query->result();
}
public function patient_record($data){
 ...
 public function get_patient_by_id($id) {
    ...
    return $query->row(); // row() returns an object. result() returns an array.
}

public function get_patient_details($id) {
    $this->db->where('pr_id', $id);
    $query = $this->db->get('patient_record');
    return $query->row(); // This ensures it returns an OBJECT
}
