...
public function search_patients($query) {
    $this->db->select('*');
    $this->db->from('patient_record'); // Ensure this matches your table name
    $this->db->like('pr_lname', $query);
    $this->db->or_like('pr_id', $query); 
    $query = $this->db->get();
    return $query->result();
}
...
public function get_patient_by_id($id) {
    ...
    $query = $this->db->get('patient_record'); // Replace 'patients' with your table name
    return $query->row();
}
